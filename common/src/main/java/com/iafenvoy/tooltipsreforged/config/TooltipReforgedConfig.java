...
public class TooltipReforgedConfig extends AutoInitConfigContainer {
    ...
    public static class TooltipConfig extends AutoInitConfigCategoryBase {
        ...
        public final IConfigEntry<Boolean> equipmentCompareTooltip = new BooleanEntry("config.tooltips_reforged.equipmentCompareTooltip", false).json("equipmentCompareTooltip");
    ...
    public static class MiscConfig extends AutoInitConfigCategoryBase {
        ...
        public final SeparatorEntry s1 = new SeparatorEntry();
        public final IConfigEntry<Boolean> overwriteRarityColor = new BooleanEntry("config.tooltips_reforged.overwriteRarityColor", false).json("overwriteRarityColor");
        public final IConfigEntry<Integer> commonRarityColor = new IntegerEntry("config.tooltips_reforged.commonRarityColor", 0x505000FF).json("commonRarityColor");
        public final IConfigEntry<Integer> uncommonRarityColor = new IntegerEntry("config.tooltips_reforged.uncommonRarityColor", 0xFFFFFF55).json("uncommonRarityColor");
        public final IConfigEntry<Integer> rareRarityColor = new IntegerEntry("config.tooltips_reforged.rareRarityColor", 0xFF55FFFF).json("rareRarityColor");
        public final IConfigEntry<Integer> epicRarityColor = new IntegerEntry("config.tooltips_reforged.epicRarityColor", 0xFFFF00FF).json("epicRarityColor");
        public final IConfigEntry<Integer> endColor = new IntegerEntry("config.tooltips_reforged.endColor", 0x505000FF).json("endColor");
        public final SeparatorEntry s2 = new SeparatorEntry();
